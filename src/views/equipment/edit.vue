        ...
        <!-- <el-divider content-position="left">基本信息</el-divider> -->
            <el-row :gutter="20">
                <el-col>
                    <div class="grid-content bg-purple">
                        <el-form-item label="采集设备编号" prop="testdate">
                ...
                <el-col >
                    <div class="grid-content bg-purple">
                        <div class="grid-content bg-purple">
                            <el-form-item label="采集设备名称" prop="blocktype">
                                <el-select placeholder="采集设备名称" v-model="damageinfolist.blockname" >
                                    <el-option
                ...
                <el-col>
                    <div class="grid-content bg-purple">
                        <el-form-item label="采集设备通道数" prop="componentid">
            ...
            <el-row :gutter="20">
                <el-col>
                    <div class="grid-content bg-purple">
                        <div class="grid-content bg-purple">
                            <el-form-item label="采集设备地址" prop="damagetype">
                                <el-input v-model="damageinfolist.componentid"></el-input>
                            </el-form-item>
                        </div>
                    </div>
                ...
                <el-col>
                    <div class="grid-content bg-purple">
                        <div class="grid-content bg-purple">
                            <el-form-item label="设备采样周期(s)" prop="scale">
                                <el-input v-model="damageinfolist.componentid"></el-input>
                            </el-form-item>
                        </div>
                    </div>
                ...
                <el-col>
                    <div class="grid-content bg-purple">
                        <el-form-item label="采样频率(Hz)" prop="inspector">
            ...
            <el-row :gutter="20">
                <el-col>
                    <div class="grid-content bg-purple">
                        <el-form-item label="设备工作模式" prop="qualitativedescription">
                            <el-select placeholder="设备工作模式" v-model="damageinfolist.blockname" >
                                    <el-option
                                    v-for="item in blocktypelist"
                                    :label="item.blockname"
                                    :key="item.blocktype"
            ...
            <el-row :gutter="20">
                <el-col >
                    <div class="grid-content bg-purple">
                        <el-form-item label="采集站" prop="quantitativedescription">
                            <el-select placeholder="采集站" v-model="damageinfolist.blockname" >
                                    <el-option
                                    v-for="item in blocktypelist"
                                    :label="item.blockname"
                                    :key="item.blocktype"
