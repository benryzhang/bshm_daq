<template>
   <div class="bottom-charts">
    ...
    <!-- <div class="bcci-header">历年降水量</div> -->
...
<script>
//import { initLineEcharts} from './../../assets/js/yjpdEchart.js'//引用文件
export default {
  data() {
    return {
        paramRefresh:[],
  ...
  name: 'Echarts',
  methods:{
      //var info={type:currentSensorTypeCode,sensorcode:JSON.stringify(vls),channelcode:'',para:para,flag:flag,startdate:startdate,enddate:enddate,direction:direction,timemode:currentTimeMode,structure:structure};
    // async initRTEchartsData(){
    //     //alert('go')
  

    //    await this.$axios.get(this.api.getAQYJRTDataByCode,{params:{type:'UAN',sensorcode:'["YZCN-UAN-T03-01"]',channelcode:'',para:'时程',flag:'R',startdate:'',enddate:'',direction:'',timemode:'R',structure:this.GLOBAL.structure}}).then(response => {
    ...
    async initRTEchartsData(){
     ...
     initLineEcharts(ec, lid, arr, seriesName, marginSize, splitFlag, xAxisType) {
  // 基于准备好的dom，初始化echarts图表
  //alert('s')
    //var myChart = ec.init(document.getElementById(lid));
    var myChart = this.$echarts.init(document.getElementById('BottomCharts'));
	// 图表的option信息
	var option = {
		// 图表title标题
		title : {
