    ...
    <el-card class="box-card">
      ...
      <template>
        ...
        id="typecode"
          ...
          <el-table-column prop="sensortypecode" label="传感器名称" fixed sortable width="200" align="center"  ></el-table-column>
          <el-table-column prop="sensorcode" label="传感器编号" width="200" sortable align="center"></el-table-column>
          <el-table-column prop="sensorname" label="数据采集列数" width="200" align="center"></el-table-column>
          <el-table-column prop="monitpara" label="采集设备编号" width="" align="center"></el-table-column>
          <el-table-column prop="monitpara" label="通道号" width="" align="center"></el-table-column>
          <el-table-column prop="monitpara" label="传感器状态" width="" align="center"></el-table-column>
          <el-table-column prop="monitpara" label="初始(修正)值" width="" align="center"></el-table-column>
          <el-table-column prop="monitpara" label="灵敏度系数(V*s2/m)" width="" align="center"></el-table-column>
...
export default {
  ...
  methods: {
    ...
    editPannel(index, row) {
        ...
        this.dialogTitle = "编辑传感器信息";
        this.$nextTick(()=>{
          this.$refs.detectionPanel.dataInit(row);
        });
    },
    addPannel(){
        this.dialogTitle = "添加传感器信息";
        this.dialogFormVisible = true;
