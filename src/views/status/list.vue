    ...
    <el-card class="box-card">
      ...
      <template>
        ...
        id="typecode"
          ...
          <el-table-column prop="sensortypecode" label="时间" fixed sortable width="200" align="center"  ></el-table-column>
          <el-table-column prop="sensorcode" label="采集仪/传感器" width="200" align="center"></el-table-column>
          <el-table-column prop="sensorname" label="计数" width="200" align="center"></el-table-column>
          <el-table-column prop="monitpara" label="信息" width="" align="center"></el-table-column>
